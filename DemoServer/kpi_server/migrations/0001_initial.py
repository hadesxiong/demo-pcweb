# Generated by Django 4.1 on 2023-09-09 17:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes_id', models.CharField(help_text='用户notesid', max_length=8, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('index_num', models.CharField(help_text='指标编号', max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('record_id', models.CharField(blank=True, help_text='上传记录编号', max_length=10)),
                ('index_num', models.CharField(help_text='指标编号', max_length=10)),
                ('detail_value', models.DecimalField(decimal_places=2, help_text='指标具体值', max_digits=18)),
                ...
                ('detail_update', models.DateTimeField(auto_now=True, help_text='修改时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('org_num', models.CharField(help_text='机构编号', max_length=10, unique=True)),
                ...
                ('org_create', models.DateTimeField(auto_now_add=True, help_text='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detail_create', models.DateField(auto_now_add=True, help_text='创建时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_update_time', models.DateTimeField(auto_now=True, help_text='上传时间')),
                ('record_update_state', models.IntegerField(help_text='该条记录状态')),
                ('record_create', models.DateTimeField(help_text='创建时间')),
                ('record_update', models.DateTimeField(auto_now=True, help_text='修改时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_belong_org', models.CharField(help_text='用户归属机构', max_length=10)),
                ('user_belong_group', models.IntegerField(help_text='用户所属分组/条线')),
                ('user_character', models.IntegerField(help_text='用户角色')),
                ('user_ext_info', models.CharField(help_text='用户信息补充字段', max_length=64)),
            ],
            options={
                'db_table': 'user_info',
            },
