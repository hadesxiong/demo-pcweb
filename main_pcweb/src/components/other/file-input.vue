<template>
  <div class="custom-upload">
    ...
    <a-upload :show-upload-list="false" :before-upload="beforeUpload" :on-success="onSuccess" v-model="fileName"
      class="d_flex jc_sb fai_c bg_l2 br_4 ta_l h_32 fc_l2 of_h tover_ell ws_no minw_100 w_a">
      <a-input :placeholder="fileName" readonly @click="openFileSelection" class="d_flex fai_c jc_sb p_0 input_file h_32">
        <template #suffix>
